        ...
        <div class="col-6 col-md-4 order-3 order-md-3 text-right">
          <div class="site-top-icons">
            <ul>
              ...
              <li><a href="<?php amigable('?module=login&function=view_login'); ?>"><span class="icon icon-person"></span></a></li>
  ...
  <nav class="site-navigation text-right text-md-center" role="navigation">
    <div class="container">
      <ul class="site-menu js-clone-nav d-none d-md-block">
        ...
        <li><a data-tr="home" href="<?php amigable('?module=home&function=view_home'); ?>"></a></li>
        <li><a data-tr="shop" href="<?php amigable('?module=shop&function=view_shop'); ?>"></a></li>
